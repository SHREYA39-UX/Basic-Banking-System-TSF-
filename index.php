  ...
  ?>
    ...
    <div class="container-fluid">
        ...
        <div class="intro py-1">
            <div >
                <div >
                   <center> <h1>Welcome to TSF Bank</h1></center>
                </div>
            </div>
        ...
        <div class="row activity text-center">
            ...
            <div class="col-md act">
                <br><br>
                <img src="money.jpg" height="316" width="400">
                <br><br>
    ...
    <footer class="text-center mt-5 py-2">
        <p>&copy 2021. Made by <b>SHREYA S V</b> <br> Task from  <b>The Sparks Foundation</b><br> Under <b>GRIP</b></br></p>
    </footer>
